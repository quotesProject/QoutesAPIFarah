...
const {Quote, db} = require("./defineDB.js")
...
async function populatingDB(url) {
  ...
  Quote.bulkCreate(quotesDB)

  // console.log(Quote)
  // const goku = await Quote.create({
  //   text: "Goku", 
  //   author: "Kamehameha"
  // })
  // console.log(Quote)
...
populatingDB("https://type.fit/api/quotes");
